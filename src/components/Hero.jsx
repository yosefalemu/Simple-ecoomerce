import "./Header.css";
import Main1 from "../img/header/home-img-1.jpeg";
import Main2 from "../img/header/home-img-2.jpeg";
import Main3 from "../img/header/home-img-3.jpeg";
import Main4 from "../img/header/home-img-4.jpeg";
          ...
          <div className="grid-container">
            <div className="featured grid-one">
              <Link to="categories/furnitures">
                ...
                <p className="main-description">Clothes</p>
              </Link>
            </div>
            <div className="featured grid-two">
              <Link to="categories/skin-care">
                ...
                <p className="main-description">Jewelry</p>
              </Link>
            </div>
